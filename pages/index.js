  ...
  return (
    <>
      ...
      <div>
        ...
        <p className={styles.text}>Among them, there was a young ninja named Hiro. Since childhood, he had dreamed of becoming a skilled ninja like his father, who had been one of the clan's greatest warriors. But Hiro faced a daunting challenge; he was born without the ability to hear. Many thought his disability would hinder his progress, but Hiro's determination burned brighter than the fiercest fire.</p>
        ...
        <p className={styles.text}>As Hiro grew, he faced both internal and external struggles. The path of a ninja was treacherous, and dark forces threatened their village. Among the shadows, an envious rival clan plotted to steal the ancient secrets held by Hiro's clan. But Hiro remained steadfast, his spirit unyielding.</p>
        <p className={styles.text}>One fateful day, when the cherry blossoms painted the village in a sea of pink, Sensei Takeshi summoned Hiro. "The time has come, my pupil," he said in a hushed voice. "The trials await you to prove your worthiness as a true ninja."</p>
        <p className={styles.text}>Hiro's heart raced with anticipation and anxiety as he embarked on a series of challenges. Each test pushed his physical and mental limits, and he encountered illusions that tested his resolve and determination. But with sheer determination and the memory of his father's legacy in his heart, Hiro overcame each trial, proving himself as a worthy heir to the silent blades.</p>
        <p className={styles.text}>But the greatest challenge still awaited him – a duel with the rival clan's deadliest assassin, Akira. Hiro knew that this battle would define his destiny. The night of the duel arrived, and under the cover of darkness, the two adversaries faced each other.</p>
        ...
        <p className={styles.text}>In the end, it was Hiro's unwavering spirit that prevailed. He disarmed Akira, sparing his life with a rare display of mercy, and delivering a message of unity among the clans.</p>
        <p className={styles.text}>Word of Hiro's valor spread like wildfire, and even those who once doubted him now revered him as a legend. He became a symbol of strength, a testament to the power of perseverance and the unity of hearts.</p>
